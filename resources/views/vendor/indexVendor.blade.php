  ...
  <div class="container pt-170 pt-md-100 pb-130 pb-md-60">
    <div class="row gutter-40">
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="team-member">
          <div class="thumb">
            <img src="assets/img/team/05.jpg" alt="Boseo-HasTech">
          </div>
          <div class="content">
            <div class="member-info">
              <h4 class="name"><a href="#/">Ryan Ricketts</a></h4>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="team-member">
          <div class="thumb">
            <img src="assets/img/team/06.jpg" alt="Boseo-HasTech">
          </div>
          <div class="content">
            <div class="member-info">
              <h4 class="name"><a href="#/">Dalton Grant</a></h4>
              <p class="designation">Senior SEO Analyst</p>
            </div>
          </div>
          <a class="icon team-btn-active" href="#/">
            <img src="assets/img/icons/eye.png" alt="Icon-Image">
